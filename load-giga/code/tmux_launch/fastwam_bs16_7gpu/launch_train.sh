...
CUDA_VISIBLE_DEVICES=1,2,3,4,5,6,7 stdbuf -oL -eL accelerate launch \
  ...
  output_dir=/mnt/data/chw/fastwam/runs/agilex_empty_box_giga_init_bs16_5k \
  ...
  weight_decay=1.0e-2 \
  wandb.enabled=false \
  2>&1 | tee -a "/mnt/data/chw/fastwam/logs/giga_to_fastwam/agilex_empty_box_giga_init_bs16_5k.log"
