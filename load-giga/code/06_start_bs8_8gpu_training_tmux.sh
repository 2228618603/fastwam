...
SESSION=${SESSION:-fastwam_bs8_8gpu_100k}
GPUS=${GPUS:-0,1,2,3,4,5,6,7}
NUM_PROCESSES=${NUM_PROCESSES:-8}
BATCH_SIZE=${BATCH_SIZE:-8}
MAX_STEPS=${MAX_STEPS:-100000}
SAVE_EVERY=${SAVE_EVERY:-5000}
RUN_DIR=${RUN_DIR:-/mnt/data/chw/fastwam/runs/agilex_empty_box_giga_init_bs8_8gpu_100k}
...
LOG_FILE=${LOG_FILE:-${LOG_DIR}/agilex_empty_box_giga_init_bs8_8gpu_100k.log}
